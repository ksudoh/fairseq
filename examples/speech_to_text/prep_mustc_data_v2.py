...
def process(args):
    ...
    for lang in set(args.lang):
        ...
        # Extract features
        audio_root = output_root / ("flac" if args.use_audio_input else "fbank80")
        ...
        zip_path = output_root / f"{audio_root.name}.zip"
        ...
        for task in set(args.task):
            ...
            spm_filename_prefix = f"spm_{vocab_type}{v_size_str}_{task}"
