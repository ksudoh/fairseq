...
if __name__ == "__main__":
    ...
    parser.add_argument("--task", required=True, type=str, choices=["asr", "st"], nargs="+")
    parser.add_argument("--lang", required=True, type=str, choices=MUSTC.LANGUAGES, nargs="+")
    parser.add_argument("--output", required=True, type=str)
    parser.add_argument("--split", required=True, choices=MUSTC.SPLITS, nargs="+")
